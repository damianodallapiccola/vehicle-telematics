...
public class SpeedRadar {
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<Tuple6<Integer, Integer, Integer, Integer, Integer, Integer>> filterOut = source.map(new MapFunction<String, Tuple6<Integer, Integer, Integer, Integer, Integer, Integer>>() {
            @Override
            public Tuple6<Integer, Integer, Integer, Integer, Integer, Integer> map(String s) {
            ...
            @Override
            public boolean filter(Tuple6<Integer, Integer, Integer, Integer, Integer, Integer> outFilter) {
                return outFilter.f5 > 90;
            }
        });
